...
```
export instructLabPath=~/instructlab
mkdir -p $instructLabPath
cd $instructLabPath
...
echo "export XDG_DATA_HOME=$instructLabPath" >> ./venv/bin/activate
echo "export XDG_CONFIG_HOME=$instructLabPath" >> ./venv/bin/activate
echo "export XDG_CACHE_HOME=$instructLabPath" >> ./venv/bin/activate
